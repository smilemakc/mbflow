...
graph TD
    ...
    style Start fill:#90EE90,color:#000000
    style End fill:#FFB6C1,color:#000000
    style CheckBilling fill:#FFD700,color:#000000
    style CheckEscalation fill:#FFD700,color:#000000
    style CheckQuality fill:#FFD700,color:#000000
    style MergeResp fill:#87CEEB,color:#000000
...
graph TD
    ...
    style Start fill:#90EE90,color:#000000
    style End fill:#FFB6C1,color:#000000
    style CheckDeepDive fill:#FFD700,color:#000000
    style Archive fill:#87CEEB,color:#000000
...
graph TD
    ...
    style Start fill: #90EE90, color: #000000
    style End fill: #FFB6C1, color: #000000
    style CheckSeverity fill: #FFD700, color: #000000
    style CheckRefactor fill: #FFD700, color: #000000
    style CheckValidation fill: #FFD700, color: #000000
