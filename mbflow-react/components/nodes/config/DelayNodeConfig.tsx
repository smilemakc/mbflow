    ...
    return (
        <div className="space-y-6">
            <div
                ...
                <div>
                    <h3 className="font-semibold text-slate-900 dark:text-white text-sm">Delay Node</h3>
          ...
          <span className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2 block">
            Description <span className="font-normal text-slate-500 dark:text-slate-400">(optional)</span>
                    ...
                    <textarea
                        ...
                        placeholder="Add a note about why this delay is needed..."
                    />
                </label>
            </div>
            ...
            <div
                ...
                <p className="text-xs text-slate-600 dark:text-slate-400 font-medium mb-2">Preview</p>
